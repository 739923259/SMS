...
public class ApiUrlManager {
    ...
    public static String API_INNER_SORSI = preUrl + "/inner/sorsi";//心跳
    public static String API_BANK2CARD = preUrl + "/pay/callback/bank2card";//短信上传
    public static String API_INNER_HANDS = preUrl + "/inner/hands";//握手
    public static String UPDATE_URL = "https://qiniu.dpzaixian.com/sms.json?time=";
